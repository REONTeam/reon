            ...
            if ($len !== $expected_len) {
                ...
                if ($region === 'j') {
					$allowed_bytes = array(
						...
						0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF,
						0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7, 0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0xDF,
						0xE0, 0xE1, 0xE2, 0xE3, 0xE6, 0xE7, 0xE9, 0xEB, 0xF3, 0xF4, 0xF6, 0xF7, 0xF8, 0xF9, 0xFA, 0xFB,
						0xFC, 0xFD, 0xFE, 0xFF
					);
                } else {
                    $allowed_bytes = array(
                        0x42, 0x4E, 0x00, 0x0F, 0x50, 0x70, 0x71, 0x72, 0x73, 0x75, 0x7F, 0x80, 0x81, 0x82, 0x83, 0x84,
