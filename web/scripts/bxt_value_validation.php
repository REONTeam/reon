        ...
        if (!is_string($mail_blob)) {
            ...
            if ($len !== $expected_len) {
                ...
                if ($region === 'j') {
                    ...
                    $allowed_bytes = array(
                        0x00, 0x10, 0x42, 0x4E, 0x00, 0x0F, 0x50, 0x70, 0x71, 0x72, 0x73, 0x75, 0x7F, 0x80, 0x81, 0x82,
                        ...
                        0xE3, 0xE4, 0xE5, 0xE6, 0xE7, 0xE8, 0xE9, 0xEA, 0xEC, 0xED, 0xEE, 0xEF, 0xF0, 0xF1, 0xF2, 0xF3,
